...
SELECT k.pk_kid                                                                              AS kid,
       ...
       array_agg(DISTINCT t.nolivedownload) && ARRAY [true]                                  AS nolivedonwload,
       array_agg(DISTINCT t.problematic) && ARRAY[true]                                      AS problematic,
...
GROUP BY k.pk_kid, languages.languages_sortable,
         ...
         akt.nolivedonwload, akt.problematic
