--This migration is kind of already done thanks to multiple generations on KM Server but this is to make sure we're on the same migration level with KM App
