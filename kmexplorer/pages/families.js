	...
	render() {
		...
		tagList = tagList.map(function(tag){
			return {
				...
				link : "/karas?"+querystring.stringify(filterTools.clear().addTag('family',tag.tid,tag.slug).getQuery()),
			...
			<div>
				...
				<div className="kmx-filter-line">
					<Pagination
						...
						size={pageSize}
						current={page}
						renderUrl={(i) => { return "/families?"+querystring.stringify(filterTools.reset().setPage(i).getQuery()); }}
						/>
