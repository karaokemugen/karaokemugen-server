...
ALTER TABLE serie_lang ALTER COLUMN fk_sid DROP NOT NULL;
ALTER TABLE kara ALTER COLUMN subfile SET NOT NULL;
ALTER TABLE kara ALTER COLUMN created_at TYPE TIMESTAMP;
ALTER TABLE kara ALTER COLUMN modified_at TYPE TIMESTAMP;
ALTER TABLE kara DROP COLUMN fk_repo_name;
ALTER TABLE stats_favorites RENAME TO favorites;
ALTER TABLE stats_played RENAME TO played;
ALTER TABLE stats_requested RENAME TO requested;
DROP VIEW stats;
