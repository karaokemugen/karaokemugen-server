...
export async function selectAllSeries(filter?: string, from = 0, size = 0): Promise<DBSeries[]> {
	...
	const query = sql.getSeries(filterClauses.sql, limitClause, offsetClause);
